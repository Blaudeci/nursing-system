...
<div class="row">
	...
	<div class="col-sm-12">
		<div class="col-sm-12 form-group">
			...
			<textarea class="form-control" rows="10" name="anotacao_enfermagem" id="anotacao_enfermagem">{{$ocorrencias->anotacao_enfermagem}}</textarea>
		</div>
	</div>
</div>
<br>
...
<button type="submit" class="btn-register btn-register__ocorrencia btn btn-primary" onclick="document.form.submit();">Cadastrar</button>