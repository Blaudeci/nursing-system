...
<div class="row">
	<div class="col-sm-12">
		<div class="col-sm-12 form-group">
			...
			<textarea class="form-control" rows="5" name="prescricao_enfermagem" id="prescricao_enfermagem"></textarea>
		</div>
	</div>
	<div class="col-sm-12">
		<div class="col-sm-12 form-group">
			<label for="evolucao_enfermagem">Evolução de Enfermagem:</label>
			<textarea class="form-control" rows="5" name="evolucao_enfermagem" id="evolucao_enfermagem"></textarea>
		</div>
	</div>
</div>
<br>
...
<button type="submit" class="btn-register btn btn-primary" onclick="document.form.submit();">Cadastrar</button>
