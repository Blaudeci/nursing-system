					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="acidente_vascular" name="acidente_vascular">
			      			<option value="" hidden @if ($morbida->acidente_vascular == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="cancer" name="cancer">
			      			<option value="" hidden @if ($morbida->cancer == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="hipertensao" name="hipertensao">
			      			<option value="" hidden @if ($morbida->hipertensao == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="cardiopatia" name="cardiopatia">
			      			<option value="" hidden @if ($morbida->cardiopatia == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="diabetes" name="diabetes">
			      			<option value="" hidden @if ($morbida->diabetes == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="doenca_renal" name="doenca_renal">
			      			<option value="" hidden @if ($morbida->doenca_renal == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="pneumopatia" name="pneumopatia">
			      			<option value="" hidden @if ($morbida->pneumopatia == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="drogas" name="drogas">
			      			<option value="" hidden @if ($morbida->drogas == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="alimentos" name="alimentos">
			      			<option value="" hidden @if ($morbida->alimentos == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="cosmeticos" name="cosmeticos">
			      			<option value="" hidden @if ($morbida->cosmeticos == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="esparadrapo" name="esparadrapo">
			      			<option value="" hidden @if ($morbida->esparadrapo == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="la_alergico" name="la_alergico">
			      			<option value="" hidden @if ($morbida->la_alergico == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="tabagismo" name="tabagismo">
			      			<option value="" hidden @if ($morbida->tabagismo == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="etilismo" name="etilismo">
			      			<option value="" hidden @if ($morbida->etilismo == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="quimioterapia" name="quimioterapia">
			      			<option value="" hidden @if ($morbida->quimioterapia == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="radioterapia" name="radioterapia">
			      			<option value="" hidden @if ($morbida->radioterapia == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="dependencia_quimica" name="dependencia_quimica">
			      			<option value="" hidden @if ($morbida->dependencia_quimica == '')  selected="selected" @endif>Selecione</option>
					...
					<div class="input-group">
						<span class="input-group-addon">
			      		...
			      		<select class="form-control" id="violencia" name="violencia">
			      			<option value="" hidden @if ($morbida->violencia == '')  selected="selected" @endif>Selecione</option>
